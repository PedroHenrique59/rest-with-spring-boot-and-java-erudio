...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/190</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/688</href></links>"));
        ...
        assertTrue(content.contains("<page><size>10</size><totalElements>1001</totalElements><totalPages>101</totalPages><number>3</number></page>"));
    }
